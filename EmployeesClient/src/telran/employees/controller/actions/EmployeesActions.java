...
public class EmployeesActions {
	...
	public static Item[] getEmployeesItems(EmployeesMethods employeesService, List<String> departments, InputOutput io) throws Exception {
	...
	private static List<Item> getAdminItems() throws Exception {
		List<Item> res = new ArrayList<>();
		res.add(Item.of("Add Employee", t -> {
			try {
				addEmployee(t);
			} catch (Exception e) {
				t.writeObjectLine(e.getLocalizedMessage());
			}
		}));
	...
	private static List<Item> getUserItems() throws Exception {
		List<Item> res = new ArrayList<>();
	...
	private static List<Item> getExitItems() throws Exception {
		List<Item> res = new ArrayList<>();
		try {
